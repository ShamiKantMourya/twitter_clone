...
const Model: React.FC<ModelProps> = ({
    ...
    return (
        <>
            <div className="justify-center items-center flex overflow-x-hidden overflow-y-hidden fixed inset-0 z-50 outline-none focus:outline-none bg-neutral-800 bg-opacity-50">
                <div className="relative w-full lg:max-w-3xl my-6 mx-auto lg:w-3/6 h-full lg:h-auto">
                    {/* CONTENT */}
